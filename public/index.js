...
///// TEST//////////
function testH1(){
  fetch(' http://192.168.198.174:39329/iotgateway/read?ids=CH.IP155.5_YOL_CEKME_DOGRULTMA_BASINCI_ROLL_2')
  .then(response => response.text())
  .then(text => console.log(text))

  
  // var stringResponse = response.text()
